...
pub const mangrove_propagule = Block(
  ...
  "minecraft:mangrove_propagule",
  [Int("age", 0, 4), Bool("hanging"), Int("stage", 0, 1), Bool("waterlogged")],
)
...
pub const oak_leaves = Block(
  ...
  "minecraft:leaves",
  [Int("distance", 1, 7), Bool("persistent"), Bool("waterlogged")],
)
...
pub const tnt = Block("minecraft:tnt", "minecraft:tnt", [Bool("unstable")])
...
pub const creaking_heart = Block(
  ...
  "minecraft:creaking_heart",
  [Bool("active"), Enum("axis", ["x", "y", "z"]), Bool("natural")],
)
...
pub const wheat = Block("minecraft:wheat", "minecraft:crop", [Int("age", 0, 7)])
...
pub const furnace = Block(
  "minecraft:furnace",
  "minecraft:furnace",
  [Enum("facing", ["north", "south", "west", "east"]), Bool("lit")],
)

pub const oak_sign = Block(
  "minecraft:oak_sign",
  "minecraft:standing_sign",
  [Int("rotation", 0, 15), Bool("waterlogged")],
)
...
pub const ladder = Block(
  "minecraft:ladder",
  "minecraft:ladder",
  [Enum("facing", ["north", "south", "west", "east"]), Bool("waterlogged")],
)
...
pub const oak_hanging_sign = Block(
  ...
  [Bool("attached"), Int("rotation", 0, 15), Bool("waterlogged")],
)
...
pub const cake = Block("minecraft:cake", "minecraft:cake", [Int("bites", 0, 6)])
...
pub const chain = Block(
  "minecraft:chain",
  "minecraft:chain",
  [Enum("axis", ["x", "y", "z"]), Bool("waterlogged")],
)
...
pub const vine = Block(
  "minecraft:vine",
  "minecraft:vine",
  [Bool("east"), Bool("north"), Bool("south"), Bool("up"), Bool("west")],
)
...
pub const resin_brick_slab = Block(
  ...
  "minecraft:slab",
  [Enum("type", ["top", "bottom", "double"]), Bool("waterlogged")],
)
...
pub const brewing_stand = Block(
  ...
  "minecraft:brewing_stand",
  [Bool("has_bottle_0"), Bool("has_bottle_1"), Bool("has_bottle_2")],
)
...
pub const end_portal_frame = Block(
  ...
  "minecraft:end_portal_frame",
  [Bool("eye"), Enum("facing", ["north", "south", "west", "east"])],
)
...
pub const cocoa = Block(
  "minecraft:cocoa",
  "minecraft:cocoa",
  [Int("age", 0, 2), Enum("facing", ["north", "south", "west", "east"])],
)
...
pub const skeleton_skull = Block(
  ...
  "minecraft:skull",
  [Bool("powered"), Int("rotation", 0, 15)],
)
...
pub const hopper = Block(
  "minecraft:hopper",
  "minecraft:hopper",
  [Bool("enabled"), Enum("facing", ["down", "north", "south", "west", "east"])],
)
...
pub const light = Block(
  "minecraft:light",
  "minecraft:light",
  [Int("level", 0, 15), Bool("waterlogged")],
)
...
pub const pitcher_crop = Block(
  ...
  "minecraft:pitcher_crop",
  [Int("age", 0, 4), Enum("half", ["upper", "lower"])],
)
...
pub const kelp = Block("minecraft:kelp", "minecraft:kelp", [Int("age", 0, 25)])
...
pub const sea_pickle = Block(
  ...
  "minecraft:sea_pickle",
  [Int("pickles", 1, 4), Bool("waterlogged")],
)
...
pub const scaffolding = Block(
  ...
  "minecraft:scaffolding",
  [Bool("bottom"), Int("distance", 0, 7), Bool("waterlogged")],
)
...
pub const structure_block = Block(
  ...
  "minecraft:structure",
  [Enum("mode", ["save", "load", "corner", "data"])],
)
...
pub const bee_nest = Block(
  "minecraft:bee_nest",
  "minecraft:beehive",
  [Enum("facing", ["north", "south", "west", "east"]), Int("honey_level", 0, 5)],
)
...
pub const candle = Block(
  "minecraft:candle",
  "minecraft:candle",
  [Int("candles", 1, 4), Bool("lit"), Bool("waterlogged")],
)
...
pub const sculk_shrieker = Block(
  ...
  "minecraft:sculk_shrieker",
  [Bool("can_summon"), Bool("shrieking"), Bool("waterlogged")],
)
